  ...
  def account_items
    [
      { key: :passkeys,
        ...
        disabled: false },
      { key: :users,
        label: I18n.t("opensop.nav.users", default: "Users"),
        icon: :user_circle,
        path: helpers.ui_account_users_path,
        active: path_active?(helpers.ui_account_users_path),
        disabled: false }
    ]
  end
